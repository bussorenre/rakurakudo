...
-(id)init{
    ...
    self = [super init];
    if(self){
        NSLog(@"init in toRitsViewController");
        ...
        if (frame.size.height > 500.0) { // iPhone 4inch (568 - 20 px)
            ...
            //view6.frame = CGRectMake(20,205,140,30);
            view7.frame = CGRectMake(0,196,160,52.5);
            //view8.frame = CGRectMake(110,152,100,35);
            //view9.frame = CGRectMake(110,187,100,70);
            //view10.frame = CGRectMake(180,205,140,30);
        ...
        UILabel *lbl5_1 = [[[UILabel alloc]initWithFrame:CGRectMake(0,2,160,20)]autorelease];
        ...
        //ラベル「分(00:00)」
        label7 = [[[UILabel alloc]initWithFrame:CGRectMake(0,30,155,20)]autorelease];
